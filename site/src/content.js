...
export const RELIC_CATALOG = Object.freeze([
  ...
  { id: "rain-charm", type: "relic", rarity: "common", tags: ["control", "water"], name: "빗물 부적", glyph: "雨", desc: "첫 수 매치가 지연을 1회 부여", effects: [{ type: "firstWaterDelay", turns: 1 }] },
  { id: "stone-tortoise", type: "relic", rarity: "uncommon", tags: ["defense", "earth"], name: "돌거북패", glyph: "龜", desc: "보호막이 20 이상이면 받는 피해 -15%", effects: [{ type: "guardedDamageReduction", ratio: .15 }] },
  { id: "golden-needle", type: "relic", rarity: "uncommon", tags: ["damage", "metal"], name: "금침", glyph: "針", desc: "금 매치 4개 이상이면 보호막 6 관통", effects: [{ type: "metalPierce", amount: 6 }] },
  { id: "ember-jar", type: "relic", rarity: "uncommon", tags: ["damage", "fire"], name: "불씨 항아리", glyph: "炎", desc: "화상이 끝날 때 피해 4 추가", effects: [{ type: "burnEcho", amount: 4 }] },
  { id: "sprout-knot", type: "relic", rarity: "uncommon", tags: ["heal", "wood"], name: "새싹 매듭", glyph: "芽", desc: "회복 초과량의 절반을 보호막으로 전환", effects: [{ type: "overhealShield", ratio: .5 }] },
...
export const EVENT_CATALOG = Object.freeze([
  { id: "old-library", name: "낡은 서고", description: "먼지 속 목간이 대가를 요구합니다.", choices: [
    { id: "forget", label: "성어 하나를 봉인하고 희귀 유물 획득", effects: [{ type: "removeIdiom", count: 1 }, { type: "gainRareRelic", count: 1 }] },
  ...
  { id: "five-gates", name: "오행의 문", description: "주력 오행과 다른 문이 더 밝게 빛납니다.", choices: ELEMENT_CYCLE.slice(0, 3).map((element) => ({ id: element, label: `${element} 공명 획득`, effects: [{ type: "elementAffinity", element, amount: 1 }] })) },
...
const ENCOUNTER_ROWS = [
  ...
  ["moon-boss",3,"boss","water-sea","wild-sea",520,28,"심해월 자령왕"]
];
